      ...
      <?php $this->load->view('menu_user'); ?>
		...
		<table>
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
			 <form role="form" id="" action="<?php echo base_url(); ?>index.php/peminjamanuser/tambah_Akun_Aksi" method="post" enctype="multipart/form-data">
				...
				placeholder="Inputkan jumlah Peminjaman" required value="">
				</div> <br>
				...
				placeholder="Inputkan Lama Peminjaman" required value="">
				</div>
