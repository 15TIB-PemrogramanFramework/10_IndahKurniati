...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Data Peminjaman</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                        <li><i class="icon_document_alt"></i>Data Peminjaman</li>
                        
                    </ol>
<div class="col-md-12 text-right">
  <a href="<?php echo site_url('index.php/peminjaman/tambah'); ?>" 
...
<tbody>
  ...
  <tr>
      <th><?php echo $value->id_peminjaman; ?></th>
      <th><?php echo $value->nama_nasabah; ?></th>  
      <th><?php echo $value->jumlah; ?></th>
      <th><?php echo $value->tanggal_peminjaman; ?></th>
      <th><?php echo $value->lama_peminjaman; ?></th>
      
      <th>
        <a onclick="return confirm('Anda Yakin Akan Menghapus Data ini ... ?')" href="<?php echo site_url('index.php/peminjaman/delete/'.$value->id_peminjaman); ?>" class="btn btn-danger">
          <i class="fa fa-trash-o "></i>
        </a>
        <a onclick="return confirm('Anda Yakin Akan Mengedit Data ini ... ?')" href="<?php echo site_url('index.php/peminjaman/update/'.$value->id_peminjaman); ?>" class="btn btn-warning">
