    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <div class="card card-inverse">
          <img class="card-img img-fluid w-100" src="<?php echo base_url();?>assets/img/bg11.png" alt="">
          <div class="card-img-overlay bg-overlay"><br>
            ...
            <center><h2 class="card-title text-shadow text-white text-uppercase mb-0">Anda Telah Melakukan Pembayaran</h2></center>
            <center><h4 class="text-shadow text-white">Jumlah Angsuran
            <?php echo date($this->input->post('bayar_angsuran')); ?></h4></center>
            <center><h4 class="text-shadow text-white">Angsuran Ke
            <?php echo ($this->input->post('angsuran_ke')); ?></h4></center>
