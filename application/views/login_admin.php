...
<div class="bg-faded p-4 my-4">
  ...
  <section id="content">
   <form action="<?php echo site_url('index.php/login_admin/aksi_login'); ?>" method="POST">
        <div>
        <label>Username</label>
            <input type="text" placeholder="username_admin" required="" name="username_admin" />
        </div>
        <div>
        <label>Password</label>
            <input type="password" placeholder="password_admin" required="" name="password_admin" />
        </div>
        <div>
