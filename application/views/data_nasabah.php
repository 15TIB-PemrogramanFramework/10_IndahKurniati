...
<html lang="en">
  ...
  <section id="container" class="">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">IndahKurniati</span>
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Data Nasabah</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                        <li><i class="icon_document_alt"></i>Data Nasabah</li>
  ...
  <a href="<?php echo site_url('index.php/nasabah/tambah'); ?>" 
...
<tbody>
  ...
  <tr>
      ...
      <th>
        <a onclick="return confirm('Anda Yakin Akan Menghapus Data ini ... ?')" href="<?php echo site_url('index.php/nasabah/delete/'.$value->id_nasabah); ?>" class="btn btn-danger">
          <i class="fa fa-trash-o"></i>
        </a>
        <a onclick="return confirm('Anda Yakin Akan Mengedit Data ini ... ?')" href="<?php echo site_url('index.php/nasabah/update/'.$value->id_nasabah); ?>" class="btn btn-warning">
