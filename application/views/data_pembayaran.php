...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Data Pembayaran</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                        <li><i class="icon_document_alt"></i>Data Pembayaran</li>
                        
                    </ol>

<div class="col-md-12 text-right">
  <a href="<?php echo site_url('index.php/pembayaran/tambah'); ?>" 
...
<tbody>
  ...
  <tr>
      <th><?php echo $value->id_pembayaran; ?></th>
      <th><?php echo $value->nama_nasabah; ?></th>  
      
      <th><?php echo $value->jumlah_pinjaman; ?></th>
      <th><?php echo $value->bayar_angsuran; ?></th>
      
      <th><?php echo $value->angsuran_ke; ?></th>
      
      <th>
        <a onclick="return confirm('Anda Yakin Akan Menghapus Data ini ... ?')" href="<?php echo site_url('index.php/pembayaran/delete/'.$value->id_pembayaran); ?>" class="btn btn-danger">
          <i class="fa fa-trash-o"></i>
        </a>
        <a onclick="return confirm('Anda Yakin Akan Mengedit Data ini ... ?')" href="<?php echo site_url('index.php/pembayaran/update/'.$value->id_pembayaran); ?>" class="btn btn-warning">
