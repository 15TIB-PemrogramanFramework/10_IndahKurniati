...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Data Staff</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="icon_document_alt"></i>Data Staff</li>
						
					</ol>
				
      <div class="row">
  <div class="col-md-12 text-right">
  <a href="<?php echo site_url('index.php/staf/tambah'); ?>" 
...
<tbody>
  ...
  <tr>
      ...
      <th>
        <a onclick="return confirm('Anda Yakin Akan Menghapus Data ini ... ?')" href="<?php echo site_url('index.php/staf/delete/'.$value->id_staf); ?>" class="btn btn-danger">
          <i class="fa fa-trash-o"></i>
        </a>
        <a onclick="return confirm('Anda Yakin Akan Mengedit Data ini ... ?')" href="<?php echo site_url('index.php/staf/update/'.$value->id_staf); ?>" class="btn btn-warning">
